...
export default function DesignToolBar() {
  const { editButtonText, onUpdateFAQsModalOpen } = useDesignCasketContext();
  ...
  return <div className="design-casket__tool-bar">
    ...
    <div className="tool-box __faqs">
      <button className="design-casket__button" onClick={ onUpdateFAQsModalOpen }>
    ...
    <div className="tool-box __edit-image">
      <button className="design-casket__button">{ editButtonText }</button>
    </div>
